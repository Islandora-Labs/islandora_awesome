...
A curated list of great modules and other tools for Islandora Legacy (formerly known as 7.x) that are not included in the core release. Inspired by the [awesome](https://github.com/sindresorhus/awesome) list.

For Islandora 2.0 (formerly Islandora 8) modules, see the [Islandora Cookbook](https://github.com/Islandora-Labs/Islandora-Cookbook).
...
### Custom Views
Views that are useful. To import a single config go to __admin/config/development/configuration/single/import__ and select the __Configuration type__ then paste the view into the text field. 
