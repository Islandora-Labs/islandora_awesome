...
* [Islandora Datastream CRUD](https://github.com/mjordan/islandora_datastream_crud) (Stable) - Islandora Drush module for performing Create, Read, Update, and Delete operations on datastreams. Doesn't modify datastreams, just helps you create, read, update, and delete them.
